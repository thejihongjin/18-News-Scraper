...
app.get("/article/:id", function (req, res) { // route for getting one article by id and its notes
...
app.post("/note/:id", function (req, res) { // route for saving/updating note on specified article
